...
Public Function SetDimensions(newWidth As Long, ByVal newHeight As Long)
    ORB_HEIGHT = 198
    ORB_WIDTH = 66
...
Sub ChangeFrame(theFrame As Long)
     'winSize.cy = ORB_HEIGHT * theFrame
End Sub
...
Private Sub timWindowChecker_Timer()
     'Debug.Print "frmTaskbar Info; " & frmTaskbar.Top / Screen.TwipsPerPixelY & ":" & frmTaskbar.Left / Screen.TwipsPerPixelX & " " & _
                 frmTaskbar.ScaleWidth & " - " & frmTaskbar.ScaleHeight & " "; frmTaskbar.Visible
End Sub
